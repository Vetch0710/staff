...
<!-- 
      <el-form-item label="用药日期-开始" prop="inputtime">
        <el-date-picker clearable size="small" style="width: 200px"
          ...
          type="date"
          value-format="yyyy-MM-dd"
          placeholder="选择用药日期-开始">
        </el-date-picker>
      </el-form-item>
      <el-form-item label="用药日期-结束" prop="inputtime">
        <el-date-picker clearable size="small" style="width: 200px"
          v-model="queryParams.endinputtime"
          type="date"
          value-format="yyyy-MM-dd"
          placeholder="选择用药日期-结束">
        </el-date-picker>
      </el-form-item>
       -->
...
export default {
  ...
  created() {
    ...
    this.queryParams.patientname= this.$route.query.patientname;
    let qmonth = this.$route.query.inputtime;
    this.dateRange = this.getQueryDate(qmonth);
  ...
  methods: {
    ...
    //日期区间初始化
    getQueryDate(MonStr){
      let nowDate = new Date(MonStr+'-1');
      let cloneNowDate = new Date(MonStr+'-1');
